...
class BarangController extends Controller
{
    ...
    {
        // barang_nama harus diisi, berupa string, minimal 3 karakter, dan bernilai unik di tabel m_barang kolom barang_nama
        $request->validate([
            'barang_kode' => 'required|string|min:3|unique:m_barang,barang_kode',
            'barang_nama' => 'required|string|max:100', // nama harus diisi, berupa string, dan maksimal 100 karakter
            'harga_beli'  => 'required|integer',          // Password minimal 5 karakter
            'harga_jual'  => 'required|integer',         // kategori_id harus diisi dan berupa angka
