        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_barang.xlsx') }}" class="btn btn-info 
                    btn-sm" download><i class="fa fa-file-excel"></i>Download</a>
                    <small id="error-kategori_id" class="error-text form-text 
                    text-danger"></small>
                </div>
                <div class="form-group">
                    ...
                    <small id="error-file_barang" class="error-text form-text 
                    text-danger"></small>
                </div>
            </div>
